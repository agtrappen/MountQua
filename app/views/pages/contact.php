    ...
    <div class="container">
        ...
        <form class="my-md-4">
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="onderwerp" id="onderwerp">
                    <option selected>Selecteer het onderwerp</option>
                    <option value="Kwaliteit">Kwaliteit</option>
                    <option value="Product">Product</option>
                    <option value="Sponsors">Sponsors</option>
                    <option value="Werken bij MountQua">Werken bij MountQua</option>
                </select>
            </div>
            <div class="form-group">
