...
class Products extends Controller
{
  ...
  /**
   * Search method
   * Receives search query and returns found products to products/search page
   * 
   * @return array Products found with search query
   */
  public function search()
  {
    ...
    $products = $this->productsModel->getProductsWithSearch($search);
